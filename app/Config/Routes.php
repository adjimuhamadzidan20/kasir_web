...
// data kategori
$routes->get('/data_kategori', 'DataKategori::index', ['filter' => 'administrator']);
...
// $routes->get('/data_kategori/tambah_kategori', 'DataKategori::tambahkategori', ['filter' => 'administrator']);

// data produk
$routes->get('/data_produk', 'DataProduk::index', ['filter' => 'administrator']);
...
// $routes->get('/tambah_produk', 'DataProduk::tambah', ['filter' => 'administrator']);
